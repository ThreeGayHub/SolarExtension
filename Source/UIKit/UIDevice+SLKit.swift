...
public extension UIDevice {
    ...
    public class var hostName: String {
...
public extension UIDevice {
    ...
    public class var platform: SLPlatform {
        let hardware = hardwareString
        
        if hardware.hasPrefix("i386") || hardware.hasPrefix("x86_64") { return .Simulator }
        if hardware.hasPrefix(SLPlatform.iPhone.rawValue) { return .iPhone }
        if hardware.hasPrefix(SLPlatform.iPodTouch.rawValue) { return .iPodTouch }
        if hardware.hasPrefix(SLPlatform.iPad.rawValue) { return .iPad }
        if hardware.hasPrefix(SLPlatform.AppleTV.rawValue) { return .AppleTV }
        if hardware.hasPrefix(SLPlatform.AppleWatch.rawValue) { return .AppleWatch }
        
        return .Unknown
    }
    
    public enum SLPlatform: String {
...
public extension UIDevice {
    ...
    public class var phoneModel: SLPhoneModel {
        let hardware = hardwareString
...
public extension UIDevice {
    ...
    public class var hardwareString: String {
